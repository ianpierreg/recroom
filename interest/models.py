...
class InterestType(models.Model):
    name = models.CharField("Tipo de interesse", max_length=1000, null=False, blank=False)
    description = models.CharField("Descrição do tipo de interesse", max_length=1000, null=True, blank=True)
